...
{
    public partial class ModificarDatos_Parte2 : Form
    {
        UsuarioRegistrado objUsarioRegistrado;
        ModificarDatos objModificarAnterior;
        ...
        public ModificarDatos_Parte2(ModificarDatos objModificarAnterior, PaginaPrincipal principal, UsuarioRegistrado objUsarioRegistrado, int? originalID, string nuevoNombre, string nuevoApellido, string nuevoCorreo, string nuevoUsuario, string nuevoGenero, int? nuevaID, string nuevoTipoID)
        {
            InitializeComponent();
        ...
        private void lblMantenerFinalizar_ModifParte2_Click(object sender, EventArgs e)
        {
            this.Hide();
            objModificarAnterior.Show(); 
